...
export default function Page() {
  ...
  const [annualRate, setAnnualRate] = useState(10); // percent per annum
        ...
        <div className="p-5 sm:p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <div className="bg-gray-50 p-4 rounded-md">
              <h3 className="text-sm font-medium text-gray-600">Flat Rate</h3>
            ...
            <div className="bg-gray-50 p-4 rounded-md">
              ...
              <div className="mt-2 grid grid-cols-2 gap-2 text-sm">
                ...
                <div className="font-medium">Total Interest</div>
                <div className="text-right">{fmt(reducing.totalInterest)}</div>
                <div className="font-medium">Total Payable</div>
                <div className="text-right">{fmt(reducing.totalPayable)}</div>
              </div>
            </div>
          </div>
        </div>
