...
import UserNavigation from "./components/HomePageBlob/UserNavigation";
...
export default function RootLayout({ children }) {
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body className={`${inter.className} ${LobsterTwo.className} bg-white`}>
        <ThemeProvider
          attribute="class"
          defaultTheme="system"
          enableSystem
